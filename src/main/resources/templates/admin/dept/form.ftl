                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/dept/edit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="name" class="form-control" type="text" value="${dept.name}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                	<select name="status" class="form-control">
                                		<option value="0" <#if dept.status == 0>selected="selected"</#if>>正常</option>
                                		<option value="1" <#if dept.status == 1>selected="selected"</#if>>禁用</option>
                                	</select>
                                </div>
                            </div>
                            <div class="form-group">
